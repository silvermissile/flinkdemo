...
public class Hive2HbaseAsi {
    ...
    public static void main(String[] args) throws Exception {
        ...
        config.setString("table.exec.hive.infer-source-parallelism.max", "80");
...
// set the HiveCatalog as the current catalog of the session
        ...
        String hbaseTable = "CREATE TABLE if not exists tmp.h9Table (\n" +
                ...
                " 'zookeeper.quorum' = '192.22.8.86:2181,192.22.8.87:2181,192.22.8.88:2181'\n" +
                ")";
